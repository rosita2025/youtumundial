...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Política de privacidad — Ropa de Youtumundial" },
      {
        name: "description",
        content:
          "Cómo Youtumundial recolecta, usa y protege tus datos personales al comprar en la tienda.",
      },
      { property: "og:title", content: "Política de privacidad — Ropa de Youtumundial" },
      {
...
function PrivacyPage() {
  return (
    <StaticPage
      ...
      intro="Esta página explica qué datos pedimos, para qué los usamos y qué podés hacer con ellos."
    ...
    >
      ...
      <Section heading="Para qué los usamos">
        <p>
          Únicamente para preparar y despachar tu pedido, comunicarte el estado del envío, atender
          consultas y cumplir obligaciones contables o legales. Si te suscribís al newsletter, te
          enviamos novedades y promociones; podés darte de baja cuando quieras.
        </p>
      </Section>

      <Section heading="Con quién los compartimos">
        <p>
          Compartimos solo lo imprescindible con: el proveedor de pagos (Stripe), el proveedor
          logístico que prepara y despacha el paquete, y las empresas de transporte encargadas de la
          entrega. No vendemos ni cedemos tus datos a terceros con fines publicitarios.
        </p>
      </Section>
